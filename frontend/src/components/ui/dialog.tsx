...
// Dialog genérico (shadcn padrão) sobre o `Dialog` de `radix-ui` — mesma
// convenção de `sheet.tsx`/`alert-dialog.tsx` já existentes no projeto.
// Base do lightbox de fotos (Story 3.6, spec-3-6): overlay e `Esc` fecham
// por comportamento nativo do Radix, sem código extra.
