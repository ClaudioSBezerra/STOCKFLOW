...
func TestGerarCatalogoXLSX_GrupoComEstoques(t *testing.T) {
	...
	criarProdutoCatComSaldo(t, db, CriarProdutoInput{
		UnidadeMedida: "un",
		Nome:          "Prancha XLSX", CategoriaID: categoriaID,
	}, estA.ID, 10)
...
func TestGerarCatalogoXLSX_GrupoSemEstoque(t *testing.T) {
	...
	p, _ := criarProdutoCatComSaldo(t, db, CriarProdutoInput{
		UnidadeMedida: "un",
		Nome:          "Sem Linha XLSX", CategoriaID: categoriaID,
	}, estoque.ID, 0)
...
func TestGerarCatalogoXLSX_MultiplosGrupos(t *testing.T) {
	...
	criarProdutoCatComSaldo(t, db, CriarProdutoInput{
		UnidadeMedida: "un",
		Nome:          "Grupo A XLSX", CategoriaID: categoriaID,
	}, estoque.ID, 4)
	criarProdutoCatComSaldo(t, db, CriarProdutoInput{
		UnidadeMedida: "un",
		Nome:          "Grupo B XLSX", CategoriaID: categoriaID,
	}, estoque.ID, 6)
...
func TestGerarCatalogoXLSX_AutoFilterNoCabecalho(t *testing.T) {
	...
	criarProdutoCatComSaldo(t, db, CriarProdutoInput{
		UnidadeMedida: "un",
		Nome:          "AutoFilter XLSX", CategoriaID: categoriaID,
	}, estoque.ID, 1)
...
func TestGerarCatalogoXLSX_FiltroSemResultado(t *testing.T) {
	...
	criarProdutoCatComSaldo(t, db, CriarProdutoInput{
		UnidadeMedida: "un",
		Nome:          "Existe XLSX", CategoriaID: categoriaID,
	}, estoque.ID, 1)
...
func TestGerarCatalogoXLSX_CategoriaEstoqueMalformadosSoCabecalho(t *testing.T) {
	...
	criarProdutoCatComSaldo(t, db, CriarProdutoInput{
		UnidadeMedida: "un",
		Nome:          "Malformado XLSX", CategoriaID: categoriaID,
	}, estoque.ID, 1)
